...
In this notebook we also do the ecological regression and give a short analysis of the results. In order to get reasonable fluxsed, I find that it is best to relax the requirements that the transfer matrix be strictly unitary.
